...
export interface Supplement {
  ...
  category: 'foundation' | 'serotonin' | 'amino' | 'adaptogen' | 'fat-burning' | 'recovery';
...
export const SUPPLEMENTS: Supplement[] = [
  ...
  { id: 'zinc', name: 'Zinc Picolinate', dose: '15–25mg', timing: ['with-meal', 'evening'], purpose: 'Hormone regulation, immune support, insulin sensitivity', why: 'Female athletes training 4x/week deplete zinc faster. Supports estrogen/progesterone balance, immune function, and recovery from compound lifts.', phases: 'all', category: 'foundation', energyLevels: 'all', priority: 'high', color: '#00FF41' },
  ...
  // SEROTONIN
  { id: '5-htp', name: '5-HTP (Griffonia Simplicifolia)', dose: '50mg (early luteal) → 100mg (days 22–28)', timing: ['evening'], purpose: 'Serotonin synthesis, craving control, mood stability', why: 'The direct biochemical answer to luteal cravings. 5-HTP bypasses the blood-brain barrier and goes straight to serotonin synthesis — more efficiently than L-Tryptophan. Start 5–7 days before your period when serotonin naturally crashes.', phases: ['luteal', 'menstrual'], category: 'serotonin', energyLevels: 'all', priority: 'critical', color: '#BF00FF', warning: 'Do NOT combine with SSRIs or antidepressants. Do not exceed 100mg without medical guidance.' },
  { id: 'l-tryptophan', name: 'L-Tryptophan', dose: '500mg–1g', timing: ['evening'], purpose: 'Gradual serotonin support, sleep quality, mood baseline', why: 'The slower, gentler serotonin precursor. Take away from protein-heavy meals — it competes with other amino acids for brain entry. Use as a daily baseline during follicular, or alternate with 5-HTP.', phases: ['follicular', 'ovulatory'], category: 'serotonin', energyLevels: 'all', priority: 'medium', color: '#BF00FF' },
  { id: 'vitamin-c', name: 'Vitamin C (Serotonin Cofactor)', dose: '500mg', timing: ['morning', 'with-meal'], purpose: 'Serotonin synthesis cofactor, immune, collagen', why: 'Required cofactor for converting 5-HTP into serotonin alongside B6. Take with your serotonin stack. Also supports collagen synthesis for joint integrity and iron absorption during menstruation.', phases: 'all', category: 'serotonin', energyLevels: 'all', priority: 'high', color: '#FF7F50' },
  // AMINO
  { id: 'l-tyrosine', name: 'L-Tyrosine', dose: '500–1,000mg', timing: ['morning'], purpose: 'Dopamine + norepinephrine — focus, drive, clarity', why: 'Your execute amino. Dopamine drives motivation and pattern recognition — critical for trading sessions and deep building work. Don\'t take at night — stimulating. Take before your hardest cognitive work block.', phases: ['follicular', 'ovulatory', 'menstrual'], category: 'amino', energyLevels: ['medium', 'high'], priority: 'high', color: '#00D4FF' },
  ...
  { id: 'electrolytes', name: 'Electrolytes (Na, K, Mg)', dose: '1 serving', timing: ['morning', 'pre-workout'], purpose: 'Hydration, bloating management, performance', why: 'During luteal and ovulatory phases, hormonal fluid shifts require active electrolyte replenishment. Reduce salt in food, increase electrolyte supplements. Critical during fasting windows to prevent headaches.', phases: ['luteal', 'ovulatory'], category: 'foundation', energyLevels: 'all', priority: 'high', color: '#00D4FF' },
  { id: 'collagen-c', name: 'Collagen + Vitamin C', dose: '10–15g collagen + 500mg C', timing: ['morning'], purpose: 'Connective tissue integrity — peak injury risk phase', why: 'Estrogen peaks during ovulation increase ligament laxity and ACL injury risk. Collagen peptides with Vitamin C directly support tendon and ligament integrity. Take this phase seriously.', phases: ['ovulatory'], category: 'recovery', energyLevels: 'all', priority: 'high', color: '#FFB800' },
  // ADAPTOGENS
  { id: 'rhodiola', name: 'Rhodiola Rosea', dose: '200–400mg (3% rosavins standardized)', timing: ['morning'], purpose: 'Anti-fatigue, mental performance, cortisol control', why: 'Rhodiola exerts an anti-fatigue effect that increases mental performance and concentration. Take before your trading session or deep work block. Morning only — stimulating if taken late.', phases: ['follicular', 'ovulatory', 'menstrual'], category: 'adaptogen', energyLevels: ['low', 'medium'], priority: 'high', color: '#00FF41' },
  { id: 'ashwagandha', name: 'Ashwagandha (KSM-66)', dose: '300–600mg', timing: ['evening'], purpose: 'Cortisol reduction, sleep quality, stress resilience', why: 'Cortisol runs higher in the luteal phase. KSM-66 studies show significant improvement in sleep onset latency and sleep efficiency after 8 weeks. Your evening cortisol reset — especially during FTMO challenge weeks.', phases: ['luteal', 'menstrual'], category: 'adaptogen', energyLevels: 'all', priority: 'high', color: '#BF00FF' },
  ...
  { id: 'vitex', name: 'Vitex (Chasteberry)', dose: '400mg', timing: ['morning'], purpose: 'Progesterone balance, long-term PMS reduction', why: 'Long-game supplement — needs 2–3 months to show full effect. Supports progesterone balance, directly reducing the intensity of luteal phase cravings, mood shifts, and PMS over time. This is investing in your monthly baseline.', phases: ['luteal'], category: 'adaptogen', energyLevels: 'all', priority: 'medium', color: '#BF00FF' },
  ...
  { id: 'maca', name: 'Maca Root (Black Maca)', dose: '1.5–3g in morning smoothie', timing: ['morning'], purpose: 'Hormone balance, energy consistency, cognition', why: 'Black maca specifically supports cognitive function and energy consistency across cycle phases. Balances hormones without directly acting on estrogen. Mild nutty flavor — add to your morning smoothie.', phases: 'all', category: 'adaptogen', energyLevels: ['low', 'medium'], priority: 'medium', color: '#FFB800' },
...
export const CATEGORY_META: Record<string, { label: string; color: string; icon: string }> = {
  ...
  'fat-burning': { label: 'FAT BURN', color: '#FF4757', icon: '⚡' },
